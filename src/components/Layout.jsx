...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: 'hsl(var(--background))', backgroundImage: 'url(https://media.base44.com/images/public/6a1c6a3340e642df44a0130d/905bca8b6_generated_image.png)', backgroundSize: '400px 400px', backgroundRepeat: 'repeat' }}>
